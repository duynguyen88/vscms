		...
		<div class="tab-pane active" id="tab1">
				<table class="table table-striped" cellpadding="5" width="100%">
					...
					{foreach item=table from=$tables}
							...
							<tr>
								<td align="center"><a title="Code generate for {$table}" href="{$conf.rooturl_admin}codegenerator/generate/table/{$table}/redirect/{$redirectUrl}" class="btn btn-inverse"><i class="icon-circle-arrow-right icon-white"></i> {$table}</a></td>
