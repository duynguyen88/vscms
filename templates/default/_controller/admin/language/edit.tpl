...
<div class="page-header" rel="menu_language" id="utility-section"><h1>{$lang.controller.head_edit} <code>{$langFolder}{$folder}/{if $subfolder != ''}{$subfolder}/{/if}{$file}</code></h1></div>
